...
Plain, concrete copy. Recreate wording from the design handoff rather than inventing marketing language. Cohort table prices/dates in `lib/cohorts.ts` are operational data — edit that file, not hardcoded page copy.
