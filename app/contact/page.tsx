...
export const metadata: Metadata = {
  ...
  description:
    'Tell Elie Schulman about your group, the difference it is encountering, and what you hope the group might learn.',
}
      ...
      <section className="bg-primary-50 py-20 md:py-28">
        <div className="container-custom">
          ...
          <h1 className="max-w-5xl text-4xl font-bold text-primary-900 md:text-6xl">
            What does your group keep encountering without fully examining?
          </h1>
          <p className="mt-7 max-w-3xl text-xl leading-8 text-primary-700">
            A first conversation is an opportunity to understand the people involved, what is
            happening among them, and whether a facilitated group inquiry would be useful.
          </p>
        </div>
      </section>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1.15fr_0.85fr]">
            <div>
              <p className="text-lg leading-8 text-primary-700">
                You do not need to diagnose the group or arrive with a finished description.
                Begin with a concrete situation, recurring difficulty, consequential difference,
                or change the group is trying to navigate.
              </p>
              ...
              <ul className="mt-6 space-y-4">
                {context.map((item) => (
                  <li
                    key={item}
                    className="border-l-2 border-primary-300 pl-5 leading-7 text-primary-700"
                  >
                    {item}
                  </li>
                ))}
              ...
              <a
                href={`mailto:elie@cohortlearninglabs.org?subject=${subject}&body=${body}`}
                className="mt-10 inline-flex rounded-md bg-accent px-7 py-3 font-semibold text-white hover:bg-accent-hover"
              >
                Email Elie about your group
              </a>
              <p className="mt-5 text-sm leading-6 text-primary-600">
                Please do not include confidential client information, protected health
                information, or sensitive personal documents in an initial message.
              </p>
            </div>
              ...
              <ul className="mt-7 space-y-6">
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a
                      className="text-primary-700 hover:text-accent"
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a className="text-primary-700 hover:text-accent" href="tel:+15162062480">
                      +1 (516) 206-2480
                    </a>
                  </div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-primary-700">
                      ...
                      <br />
                      Serving groups internationally
                    </p>
                  </div>
                </li>
              </ul>
